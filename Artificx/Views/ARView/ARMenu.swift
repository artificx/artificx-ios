            ...
            NavigationBarView()
                VStack {
                    ...
                    Text("Page Not Available")
                        .font(.custom(Constants.AppFont.boldFont, size: 23))
...
//              TO RUN ON SIMULATION, COMMENT OUT LINE 30-END OF THIS FILE AND LINE 19. THEN, UNCOMMENT LINE 20 AND LINES 25-29 (defaultView)
